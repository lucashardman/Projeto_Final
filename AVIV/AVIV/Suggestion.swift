...
class Suggestion {
    ...
    func loadElement(addName: String, addId: String, addCategory: String, addMasterCategory: String, addMainPhoto: String, addText: String, addLink: String, addPhotoGallery: String, addCity: String, addProfile: String){
